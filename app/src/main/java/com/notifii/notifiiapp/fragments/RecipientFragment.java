...
import com.notifii.notifiiapp.sorting.SortRecipientNameDescending;
...
public class RecipientFragment extends Fragment {
    ...
    public RecipientFragment(ArrayList<Recipient> mRecipientList, String currentFragment) {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecipientAdapter = new MatchingRecipientAdapter(getActivity(), mRecipientList, "RecipientFragment");
    ...
    // @Subscriber(tag = "filterList") //this tag shud match with the tag we used in Step2.
