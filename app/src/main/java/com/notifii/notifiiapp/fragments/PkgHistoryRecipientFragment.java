 ...
 */
public class PkgHistoryRecipientFragment extends Fragment implements NTF_Constants {
    ...
    public PkgHistoryRecipientFragment(List<Package> mPackagesList, boolean isFromSearchPkg) {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.v("PackageList: ", "size: " + mPackagesList.size());
        packageHistoryAdapter = new PackageHistoryAdapter(getActivity(), mPackagesList, Extras_Keys.PKG_HISTORY_RESIDENTS_FRAGMENTS, ntf_Preferences.get(NTF_Constants.Prefs_Keys.TIMEZONE));
    ...
    public void sortRecipientNameAscending(List<Package> list) {
        Collections.sort(list, new SortByNameAscending());
        mPackagesList = list;
        notifyAdapter();
    }

    public void sortRecipientNameByDescending() {
        Collections.sort(mPackagesList, new SortByNameDescending());
        notifyAdapter();
    }
