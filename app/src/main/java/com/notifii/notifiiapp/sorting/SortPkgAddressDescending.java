 ...
 */
public class SortPkgAddressDescending implements Comparator<Package>
{
    ...
    {
        String b = o1.getRecipientAddress1().toString();
        String a = o2.getRecipientAddress1().toString();
