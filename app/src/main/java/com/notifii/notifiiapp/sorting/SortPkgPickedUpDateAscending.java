/////////////////////////////////////////////////////////////////
// SortPkgPickedUpDateAscending.java
//
...
/**
 *  This class deals with Ascending Sorting for PickupDate
 */
public class SortPkgPickedUpDateAscending implements Comparator<Package>
{
    @Override
    public int compare(Package p1, Package p2)
    {
        ...
        return p2.getDatePickedup().compareTo(p1.getDatePickedup());
    }
}