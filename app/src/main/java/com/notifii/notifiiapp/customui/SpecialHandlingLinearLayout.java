...
public class SpecialHandlingLinearLayout extends ViewGroup {

    private int paddingHorizontal;
    private int paddingVertical;

    public SpecialHandlingLinearLayout(Context context) {
        super(context);
        init();
    }

    public SpecialHandlingLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpecialHandlingLinearLayout(Context context, AttributeSet attrs, int defStyle) {
