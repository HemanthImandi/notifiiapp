...
public class FrontCameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public static int camInfoOrientation = 0;

    public FrontCameraPreview(Activity context) {
        super(context);
        mContext = context;
        isMobile = mContext.getResources().getBoolean(R.bool.isMobile);
        portrait = isPortrait();
    ...
    public int setCameraDisplayOrientation(Activity activity, int mCameraId, Camera mCamera, boolean portrait) {
        ...
        camInfoOrientation = info.orientation;
        ...
        new NTF_PrefsManager(mContext).save(NTF_Constants.Prefs_Keys.INFO_ORIENTATION, String.valueOf(info.orientation));
