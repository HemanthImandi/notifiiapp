...
public class SearchRecipientPresenter extends BasePresenter<RecipientsListView> {

    public void searchRecipientList(String header, SearchResidentRequest request) {
        Disposable disposable = NTFTrackService.getInstance(header).searchRecipientList(request)
