...
public class PackageHistoryforAccountPresenter extends BasePresenter<PackagHistoryView> {

    public void getPackageHistoryList(String header, PackageHistoryRequest request) {
        Disposable disposable = NTFTrackService.getInstance(header).getPackageHistoryList(request)
