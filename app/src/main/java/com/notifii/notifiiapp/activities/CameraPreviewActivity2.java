...
import com.notifii.notifiiapp.campkg.cameracontroller.CameraControllerManager2;
import com.notifii.notifiiapp.campkg.camui.MainUI;
import com.notifii.notifiiapp.campkg.others.MagneticSensor;
import com.notifii.notifiiapp.campkg.others.MyApplicationInterface;
import com.notifii.notifiiapp.campkg.others.MyDebug;
import com.notifii.notifiiapp.campkg.others.PermissionHandler;
import com.notifii.notifiiapp.campkg.others.PreferenceKeys;
import com.notifii.notifiiapp.campkg.others.SoundPoolManager;
import com.notifii.notifiiapp.campkg.others.SpeechControl;
import com.notifii.notifiiapp.campkg.others.StorageUtils;
import com.notifii.notifiiapp.campkg.others.TextFormatter;
import com.notifii.notifiiapp.campkg.preview.Preview;
...
public class CameraPreviewActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orientationEventListener = new OrientationEventListener(this) {
            ...
            public void onOrientationChanged(int orientation) {
                CameraPreviewActivity2.this.mainUI.onOrientationChanged(orientation);
            }
        };
        ...
        new Thread(new Runnable() {
            public void run() {
                textToSpeech = new TextToSpeech(CameraPreviewActivity2.this, new TextToSpeech.OnInitListener() {
                    @Override
    ...
    private final BroadcastReceiver cameraReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            CameraPreviewActivity2.this.takePicture(false);
        }
    };
    ...
    class PreferencesListener implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        void startListening() {
            ...
            SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(CameraPreviewActivity2.this);
