...
/**
 * This class deals with the setting hint for spinner
 */
public class SpinnerHintAdapter implements SpinnerAdapter, ListAdapter {
    ...
    public final View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            View mView=getNothingSelectedView(parent);
            TextView textView=(TextView)mView.findViewById(R.id.textview_spinner_hint);
